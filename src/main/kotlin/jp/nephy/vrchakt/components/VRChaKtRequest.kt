...
class VRChaKtRequest<M: VRChaKtModel>(private val httpClient: HttpClient, private val httpRequest: HttpRequestBuilder.() -> Unit, executor: ExecutorService, private val modelClass: Class<M>): ApiAction<M>(executor) {
